...
$outgoingServerAddress      = 'info@drinknjoy.com'; // Consult your hosting provider.
...
$sendingAccountUsername     = 'info@drinknjoy.com';
$sendingAccountPassword     = 'p@55w0rd';

// Recipient (To:) Details  - Change this to the email details of who will receive all the emails from the website.
$recipientEmail             = 'info@drinknjoy.com'; // REQUIRED value.
$recipientName              = 'David Holjevac';             // REQUIRED value.
